...
atualiza(Id,Gru_id,Con_id,Avi_id,Pec_nome,Pec_peso_bruto,Pec_peso_liquido,Pec_custo,Pec_cod_fabricacao,Pec_cod_armazenamento,Pec_estoque_max,Pec_estoque_min,Pec_qtd_estoque,Pec_sala,Pec_prateleira,Pec_gaveta,Pec_estante,Pec_corredor):-
    with_mutex(peca,
               (   retract_peca(Id,_Gru_id,_Con_id,_Avi_id,_Pec_nome,_Pec_peso_bruto,_Pec_peso_liquido,_Pec_custo,_Pec_cod_fabricacao,_Pec_cod_armazenamento,_Pec_estoque_max,_Pec_estoque_min,_Pec_qtd_estoque,_Pec_sala,_Pec_prateleira,_Pec_gaveta,_Pec_estante,_Pec_corredor),
               assert_peca(Id,Gru_id,Con_id,Avi_id,Pec_nome,Pec_peso_bruto,Pec_peso_liquido,Pec_custo,Pec_cod_fabricacao,Pec_cod_armazenamento,Pec_estoque_max,Pec_estoque_min,Pec_qtd_estoque,Pec_sala,Pec_prateleira,Pec_gaveta,Pec_estante,Pec_corredor))).

remove(Id):-
    with_mutex(peca,
    retractall_peca(Id,_Gru_id,_Con_id,_Avi_id,_Pec_nome,_Pec_peso_bruto,_Pec_peso_liquido,_Pec_custo,_Pec_cod_fabricacao,_Pec_cod_armazenamento,_Pec_estoque_max,_Pec_estoque_min,_Pec_qtd_estoque,_Pec_sala,_Pec_prateleira,_Pec_gaveta,_Pec_estante,_Pec_corredor)).
